// Small hand-rolled icon set (feather-style, stroke-based) so the app has zero
// external icon-library dependency. Usage: <Icon name="dashboard" size={18} />
const PATHS = {
  dashboard: 'M3 13h8V3H3v10zm0 8h8v-6H3v6zm10 0h8V11h-8v10zm0-18v6h8V3h-8z',
  workspace: 'M3 7l9-4 9 4-9 4-9-4zm0 5l9 4 9-4M3 17l9 4 9-4',
  projects: 'M4 6h16M4 12h16M4 18h10',
  board: 'M4 4h4v16H4V4zm6 0h4v10h-4V4zm6 0h4v13h-4V4z',
  ...
  building: 'M3 21h18M6 21V8l6-4 6 4v13M10 21v-6h4v6M9 12h.01M15 12h.01M9 9h.01M15 9h.01',
  spark: 'M12 2l1.8 5.6L19 9l-5.2 1.4L12 16l-1.8-5.6L5 9l5.2-1.4L12 2z',
